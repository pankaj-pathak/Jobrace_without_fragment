...
public class Forgot_password extends AppCompatActivity {
    ...
    public void sendOtp()
    {
        ...
        Log.d("oooootttttpp===","ooooooooooootttttttppppppppppp==="+otp);
        Shared_preference_data_class sp=new Shared_preference_data_class(Forgot_password.this);
        Log.d("email=========","user email========="+sp.getUserEmail());
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Response<String> response, Retrofit retrofit)
            {
                ...
                {
                    Toast.makeText(Forgot_password.this,"Some error occured",Toast.LENGTH_LONG).show();
                }
                pd.hide();
            }
            ...
            public void onFailure(Throwable t) {
                Toast.makeText(Forgot_password.this, "Sorry some problem occured.", Toast.LENGTH_SHORT).show();
                t.printStackTrace();
                pd.hide();
            }
        });
            ...
            public void onResponse(Response<String> response, Retrofit retrofit) {
                if(response.code()==200)
                {
                    try {
                        ...
                        String result=ar.getString(0);
                        if(result!=null && result.equals("sucess")) {
                            Toast.makeText(Forgot_password.this, "Password has changed sucessfully", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                        else if(result.equals("fail"))
                            Toast.makeText(Forgot_password.this,"You are not registered.",Toast.LENGTH_LONG).show();
