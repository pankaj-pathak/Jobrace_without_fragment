        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(retrofit.Response<String> response, Retrofit retrofit) {
                if (response.code() == 200) {
                    ...
                    Toast.makeText(My_job_list_activity.this, "Not connected with server.", Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Throwable t) {
                Toast.makeText(My_job_list_activity.this, "Some error occured", Toast.LENGTH_LONG).show();
            }
        });
    }
